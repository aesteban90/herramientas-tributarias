...
export default class TipoIdentificacionForm extends Component{
    constructor(props){        
        super(props);
        this.state = {  
            tipo: '',
    ...
    componentDidUpdate(){        
        if(this.state.idUpdate !== this.props.idUpdate ){
            ...
            if(this.props.idUpdate !== "NEW" && this.props.idUpdate !== "" ){
                axios.get(configData.serverUrl + "/tipo-identificacion/"+this.props.idUpdate)
                .then(response => {
                    this.setState({
    ...
    onSubtmit = (e) => {
        ...
        if(this.props.idUpdate === "NEW" || this.props.idUpdate === "" ){
            ...
            axios.post(configData.serverUrl + '/tipo-identificacion/add',data)
            ...
            axios.post(configData.serverUrl + '/tipo-identificacion/update/'+this.state.idUpdate,tipodocingreso)
            .then(res => this.showNotification(true))
                .then(res => this.showNotification(true))
                .catch(err => this.showNotification(false));
        }
