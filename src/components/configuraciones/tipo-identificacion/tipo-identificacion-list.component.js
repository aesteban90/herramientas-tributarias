...
import TipoIdentificacion from './tipo-identificacion-form.component';
import Modal from '../../modals/modal';
const configData = require('../../../config.json');

export default class TipoIdentificacionList extends Component{
    constructor(props){
        super(props);
        this.state = {
            datos: [],
    ...
    updateList = async (value) => {
        await axios.get(configData.serverUrl + "/tipo-identificacion/")
            .then(response => {
    ...
    deleteData = async (jsondatos) => {
        this.setState({
            ...
            modalTitle: 'Esta seguro de eliminar el Tipo Identificación?',
            modalBody: 'Tipo: '+jsondatos.tipo+' \nCódigo: '+jsondatos.codigo+'\nDescripción: '+jsondatos.descripcion 
        })
    }    
    actionConfirmModal = () =>{
        if(this.state.modalAction === "delete"){
            axios.delete(configData.serverUrl + "/tipo-identificacion/" + this.state.modalID)
        ...
        return this.state.datos.map(dato => {
            return (<li className="list-group-item" key={dato._id}>
                    ...
                    <div className="datos-table-mobile col-12 pl-1">
                        <div className="col-md-12"><b>Tipo: </b>{dato.tipo}</div>
            ...
            <div className="container">
                ...
                <div className="row">
                    ...
                    <div className="col-md-4">
                        <TipoIdentificacion idUpdate={this.state.idUpdate} onUpdateParentList={this.updateList}/>
                    </div>
                </div>
            </div>
        )
