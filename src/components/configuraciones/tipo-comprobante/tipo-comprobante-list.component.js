...
import TipoComprobante from './tipo-comprobante-form.component';
import Modal from '../../modals/modal';
const configData = require('../../../config.json');

export default class TipoComprobanteList extends Component{
    constructor(props){
        super(props);
        this.state = {
            datos: [],
    ...
    updateList = async (value) => {
        await axios.get(configData.serverUrl + "/tipo-comprobante/")
            .then(response => {
    ...
    deleteData = async (jsondatos) => {
        this.setState({
            ...
            modalTitle: 'Esta seguro de eliminar el Comprobante?',
    ...
    actionConfirmModal = () =>{
        if(this.state.modalAction === "delete"){
            axios.delete(configData.serverUrl + "/tipo-comprobante/" + this.state.modalID)
        ...
        return this.state.datos.map(dato => {
            return (<li className="list-group-item" key={dato._id}>
                    <div className="row col-12 datos-table-desktop">
                        <div className="col-md-3">{dato.tipo}</div>
                        <div className="col-md-2">{dato.codigo}</div>
                        <div className="col-md-5">{dato.descripcion}</div>
                    ...
                    <div className="row col-12 datos-table-mobile">
                        <div className="col-12"><b>Tipo: </b>{dato.tipo}</div>    
                        <div className="col-12"><b>Codigo: </b>{dato.codigo}</div>    
                        <div className="col-12"><b>Descripción: </b>{dato.descripcion}</div>    
                        <div className="row">
        ...
        return(
            <div className="container">
                ...
                <div className="row mb-0 col-md-12">
                    <h3>Lista de Tipos de Comprobantes</h3>
                </div>
                <div className="row">
                        ...
                        <div className="card">
                            <div className="card-header title-table-desktop">
                                <div className="card-title row mb-0">  
                                    ...
                                    <div className="col-md-5">Descripcion</div>   
                                    <div className="col-md-2 text-right">
                                        <button onClick={() => this.createData("NEW")} type="button" className="btn btn-success btn-sm"><FontAwesomeIcon icon={faPlus} /> Agregar Comprobante</button>
                                    </div>                                 
                                </div>
                            </div>
                    ...
                    <div className="col-md-4">
                        <TipoComprobante idUpdate={this.state.idUpdate} onUpdateParentList={this.updateList}/>
                    </div>
                </div>
            </div>
        )
