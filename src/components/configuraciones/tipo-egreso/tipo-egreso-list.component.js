...
import TipoEgreso from './tipo-egreso-form.component';
import Modal from '../../modals/modal';
const configData = require('../../../config.json');

export default class TipoEgresoList extends Component{
    constructor(props){
        super(props);
        this.state = {
            datos: [],
    ...
    deleteData = async (jsondatos) => {
        this.setState({
            ...
            modalTitle: 'Esta seguro de eliminar el Tipo de Egreso?',
            modalBody: 'Código: '+jsondatos.codigo+'\nDescripción: '+jsondatos.descripcion 
        })
    }    
    actionConfirmModal = () =>{
        if(this.state.modalAction === "delete"){
            axios.delete(configData.serverUrl + "/tipo-egreso/" + this.state.modalID)
        ...
        return(
            <div className="container">
                ...
                <div className="row mb-0 col-md-12">
                    <h3>Lista de Tipo de Egresos</h3>
                </div>
                <div className="row">
                    ...
                    <div className="col-md-4">
                        <TipoEgreso idUpdate={this.state.idUpdate} onUpdateParentList={this.updateList}/>
                    </div>
                </div>
            </div>
        )
