...
export default class FormularioEgresoForm extends Component{
    constructor(props){
    ...
    onSubtmit = (e) => {
        ...
        if(this.props.idUpdate === "NEW" || this.props.idUpdate === "" ){
            ...
            axios.post(configData.serverUrl + '/tipo-egreso/add',data)
            ...
            axios.post(configData.serverUrl + '/tipo-egreso/update/'+this.state.idUpdate,data)
                .then(res => this.showNotification(true))
                .catch(err => this.showNotification(false));
        }
    }   
