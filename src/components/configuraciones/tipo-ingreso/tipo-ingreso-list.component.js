...
export default class TipoIngresoList extends Component{
    constructor(props){
        super(props);
        this.state = {
            datos: [],
    ...
    updateList = async (value) => {
        await axios.get(configData.serverUrl + "/tipo-ingreso/")
            .then(response => {
            ...
            <div className="container">
                ...
                <div className="row">
                    ...
                    <div className="col-md-4">
                        <TipoIngreso idUpdate={this.state.idUpdate} onUpdateParentList={this.updateList}/>
                    </div>
                </div>
            </div>
        )
