...
export default class TipoDocumentoEgresoForm extends Component{
    constructor(props){        
        super(props);
        this.state = {  
            tipo: '',
    ...
    componentDidUpdate(){        
        if(this.state.idUpdate !== this.props.idUpdate ){
            ...
            if(this.props.idUpdate !== "NEW" && this.props.idUpdate !== "" ){
                axios.get(configData.serverUrl + "/tipo-documento-egreso/"+this.props.idUpdate)
                .then(response => {
                    this.setState({
    ...
    onSubtmit = (e) => {
        ...
        if(this.props.idUpdate === "NEW" || this.props.idUpdate === "" ){
            ...
            axios.post(configData.serverUrl + '/tipo-documento-egreso/add',tipodocegreso)
            ...
            axios.post(configData.serverUrl + '/tipo-documento-egreso/update/'+this.state.idUpdate,tipodocegreso)
            .then(res => this.showNotification(true))
                .then(res => this.showNotification(true))
                .catch(err => this.showNotification(false));
        }
