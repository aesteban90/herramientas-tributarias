...
export default class RegimenMatrimonialForm extends Component{
    constructor(props){        
        super(props);
        this.state = {  
            codigo:'',
    ...
    onSubtmit = (e) => {
        ...
        if(this.props.idUpdate === "NEW" || this.props.idUpdate === "" ){
            ...
            axios.post(configData.serverUrl + '/regimen-matrimonial/add',regimen)
            ...
            axios.post(configData.serverUrl + '/regimen-matrimonial/update/'+this.state.idUpdate,regimen)
                .then(res => this.showNotification(true))
                .catch(err => this.showNotification(false));
        }
    }   
